...
WebUI.setText(findTestObject('Page_Velocity Payment System2/input_Username_user'), 'iahmed2')
...
WebUI.verifyTextPresent('The information you have entered does not match our records. Please try again.', false)
